    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto space-y-8">
      ...
      <div className="w-full">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b pb-0 mb-6 gap-4 sm:gap-0">
          <div className="flex space-x-4 md:space-x-6 overflow-x-auto w-full sm:w-auto scrollbar-hide flex-nowrap">
            <Link
              href="/people"
            ...
            <table className="w-full text-sm text-left">
              <thead className="bg-slate-50 text-slate-500 border-b">
                <tr>
                  ...
                  <th className="px-6 py-4 font-medium w-1/2">Interest Description</th>
                  <th className="px-6 py-4 font-medium">Declared On</th>
                ...
                {interests.map((interest: any) => (
                  <tr key={interest.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      ...
                      {interest.description && <div className="text-slate-500 text-xs mt-1">{interest.description}</div>}
                    </td>
